...
main("source/3.6.19/1/server", "source/3.6.19/1/client/test1/6.jpg",
     "source/3.6.19/1/output3/" + str(0.25) + "/" + str(10), 0.25, 10)
'''
for dbscan in dbscan_epsilon:
    main("source/3.6.19/2/server", "source/3.6.19/2/client/test_1/77.jpg",
         "source/3.6.19/2/output1/" + str(0.45) + "/" + str(dbscan), 0.45, dbscan)
    print("$@$@$@$@$@$@ test: source/3.6.19/2/client/test_1/77.jpg")

    main("source/3.6.19/2/server", "source/3.6.19/2/client/73.jpg",
         "source/3.6.19/2/output2/" + str(0.45) + "/" + str(dbscan), 0.45, dbscan)
